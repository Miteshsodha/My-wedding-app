...
export const EventSchedule = () => {
  ...
  const scheduleItems = [
    {
      time: '25/4/2026 8:00 AM',
      event: "Ganesh Sthapna",
      description: "Shree Ganeshay Prayer",
    },
    {
      time: '25/4/2026 10:00 AM',
      event: "Lunch",
      description: "Eat and Have Fuunn!",
    },
    {
      time: '25/4/2026 9:00 PM',
      event: "Ras Garba",
      description: "Enjoy Playing Garba with Music!",
    },
    {
      time: '26/4/2026 9:00 AM',
      event: "Varghodo",
      description: "Dance With Full DJ",
    },
    {
      time: '26/4/2026 10:00 AM',
      event: "Jan Prasthan",
      description: "Going for Ceremoney",
    },
