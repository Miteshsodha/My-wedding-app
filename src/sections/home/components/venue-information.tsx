        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <button
                onClick={() =>
                  window.open("https://maps.app.goo.gl/Gn3BSdEgHDPAUeSD8", '_blank')
                }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/50 rounded-2xl p-6 space-y-4">
                ...
                <div className="space-y-2 text-xs sm:text-sm text-gray-600">
                  ...
                  <p>• {"Garba"}</p>
                  <p>• {"DJ"}</p>
                  <p>• {"Full Masti & Dhamal!"}</p>
                </div>
              </div>

              <button
                onClick={() =>
                  window.open("https://maps.app.goo.gl/wgjyME3YtyLMv3Zw7", '_blank')
                }
